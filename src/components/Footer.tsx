        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="socialMedia">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="#" className="p-2 rounded-full hover:bg-blue-600 transition">
              ...
              <Link href="#" className="p-2 rounded-full hover:bg-pink-600 transition">
              ...
              <Link href="#" className="p-2 rounded-full hover:bg-blue-400 transition">
